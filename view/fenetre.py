...
class MyWindow(Tk):
    ...
    def create(self):
        ...
        Entry(self.frame, textvariable=self.nomregle).grid(row=1, column=2)
        ...
        ### Button ###
        Button(self.frame, text="Créer", command=self.creer_nouvelle_regle).grid(row=6, column=4) # , command=)
